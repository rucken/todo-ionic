...
import { DEFAULT_PROJECTS_CONFIG, PROJECTS_CONFIG_TOKEN, TASKS_CONFIG_TOKEN } from '@rucken/todo-core';
import { IONIC_DEFAULT_TASKS_CONFIG, ProjectsListFiltersModalModule, TasksListFiltersModalModule } from '@rucken/todo-ionic';
